...
ties provides the initial electrical case. Six freshly rerun
PSCAD experiments examine baseline operation, isolation, restoration, loop
...
An additional replay of fault events from the merged networking simulator
schedules electrical isolation for a power fault and no breaker action for a
communication fault. The contribution is an auditable command-to-EMT workflow and its preliminary
