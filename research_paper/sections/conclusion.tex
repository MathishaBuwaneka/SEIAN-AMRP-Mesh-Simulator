...
fresh outputs, and measured results. Six freshly rerun deterministic scenarios provide
...
An additional event replay uses fault objects from the merged networking
simulator. It produces electrical isolation for a power fault and leaves the
switch schedule unchanged for a communication fault, confirming the
fault-domain boundary under test.
