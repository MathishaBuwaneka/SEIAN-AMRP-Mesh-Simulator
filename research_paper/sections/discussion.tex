...
The merged networking simulator can represent communication faults, learned
routes, binary packets, and radio contention. In this study those processes
were not clock-coupled to PSCAD, and no measured packet timing was used as a
breaker command delay.
